...
import { CreateClientInput, ClientTier, EnhancedClient } from '@/lib/types/agency'

interface ClientOnboardingProps {
  onClientCreated?: (client: EnhancedClient) => void
  onClose?: () => void
}
...
export default function ClientOnboarding({ onClientCreated, onClose }: ClientOnboardingProps) {
  ...
  const handleInputChange = (field: keyof CreateClientInput, value: string | string[] | ClientTier) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }))
