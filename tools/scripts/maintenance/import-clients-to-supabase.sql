-- Import clients into the clients table
...
INSERT INTO clients (user_id, business_name, contact_email, contact_phone, website, industry, business_type, category, notes, google_account_id, status, is_agency)
VALUES 
...
SELECT id, business_name, google_account_id FROM clients WHERE user_id = 'YOUR_USER_ID_HERE';